...
public class Manager implements ActionListener {
	...
	private void data() {
		...
		graph.addExcercise(new Exercise("Curl de biceps con barra", armMuscles, "3", 0, 25, 1));
		graph.addExcercise(new Exercise("Curl de biceps con mancuernas", armMuscles, "3", 0, 30, 2));
		graph.addExcercise(new Exercise("Curl de martillo", armMuscles, "4", 0, 30, 3));
		graph.addExcercise(new Exercise("Press de tríceps en polea alta", armMuscles, "3", 18.6, 30, 4));
		graph.addExcercise(new Exercise("Fondos en paralelas", armMuscles, "3", 0, 30, 5));
		...
		graph.addExcercise(new Exercise("Elevaciones laterales con mancuernas", shoulderMuscles, "3", 0, 30, 8));
		graph.addExcercise(new Exercise("Elevaciones frontales con mancuernas", shoulderMuscles, "3", 0, 30, 9));
		graph.addExcercise(new Exercise("Encogimientos de hombros con barra", hindTrunkMuscles, "3", 18.6, 25, 10));
		graph.addExcercise(
				new Exercise("Encogimientos de hombros con mancuernas", hindTrunkMuscles, "3", 0, 30, 11));
		graph.addExcercise(new Exercise("Dominadas o Pull-Ups", hindTrunkMuscles, "3", 18.6, 30, 12));
		graph.addExcercise(new Exercise("Pulldown en polea alta", hindTrunkMuscles, "3", 0, 100, 13));
		graph.addExcercise(new Exercise("Peso muerto", hindTrunkMuscles, "3", 18.6, 100, 14));
		graph.addExcercise(new Exercise("Press de banco (bench press)", anteriorTrunkMuscles, "3", 18.6, 30, 15));
		graph.addExcercise(new Exercise("Fondos en máquina de pecho", anteriorTrunkMuscles, "3", 0, 30, 16));
		...
		graph.addExcercise(new Exercise("Plancha abdominal", anteriorTrunkMuscles, "3", 0, 100, 19));
		graph.addExcercise(new Exercise("Elevación de piernas colgado", anteriorTrunkMuscles, "3", 0.0, 30, 20));
		graph.addExcercise(
				new Exercise("Push-ups con progresión de desplazamiento", anteriorTrunkMuscles, "3", 0, 30, 21));
		graph.addExcercise(new Exercise("Fondos declinados", anteriorTrunkMuscles, "3", 0, 100, 22));
		...
		graph.addExcercise(new Exercise("Prensa de piernas", hipMuscles, "3", 18.6, 30, 26));
		graph.addExcercise(new Exercise("Hip Thrust (levantamiento de cadera)", hipMuscles, "3", 18.6, 30, 27));
		graph.addExcercise(new Exercise("Sentadillas (tradicional)", thighMuscles, "3", 0, 100, 28));
		graph.addExcercise(new Exercise("Sentadillas (frontal, hack)", thighMuscles, "3", 0, 30, 29));
		graph.addExcercise(new Exercise("Extensiones de cuádriceps en máquina", thighMuscles, "3", 18.6, 30, 30));
		graph.addExcercise(new Exercise("Zancadas", thighMuscles, "3", 0, 100, 31));
		graph.addExcercise(new Exercise("Aductores en máquina", thighMuscles, "3", 25, 30, 32));
		graph.addExcercise(new Exercise("Sentadillas sumo", thighMuscles, "3", 0, 100, 33));
		graph.addExcercise(new Exercise("Prensa de piernas cerrada", thighMuscles, "3", 18.6, 30, 34));
		graph.addExcercise(new Exercise("Curl de piernas tumbado", thighMuscles, "3", 0, 30, 35));
		graph.addExcercise(new Exercise("Peso muerto", thighMuscles, "3", 18.6, 100, 36));
		...
		graph.addExcercise(new Exercise("Elevaciones de talones con mancuernas", legMuscles, "3", 0, 100, 39));
		graph.addExcercise(new Exercise("Saltos de tijera", legMuscles, "3", 0, 100, 40));
